    ...
    <>
      <div className="new-chat-heading">
        ...
        <div className="new-chat-heading__icons">
          <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="new-chat-heading__chat-icon" fill="none" onClick={handleNewChatClick}>
          ...
          <svg viewBox="0 0 24 24" height="24" width="24" preserveAspectRatio="xMidYMid meet" class="new-chat-heading__settings-icon" version="1.1" x="0px" y="0px" enable-background="new 0 0 24 24">
            <title>menu</title>
            <path
              fill="#aebac1"
